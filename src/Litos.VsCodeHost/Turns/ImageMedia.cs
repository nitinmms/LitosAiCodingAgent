...
/// every active provider (Anthropic/OpenAI/Gemini) accepts as inline image data. Local copy
/// (face-local, not shared — same convention every other face's own ImageMedia.cs follows).
/// </summary>
