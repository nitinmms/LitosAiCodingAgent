...
/// <summary>Local copy of Litos.Agent.Tests/Fakes/FakeTranscriptStore.cs — see FakeChatProvider's own note on why each test project keeps its own fakes.</summary>
