...
/// prompt command's typed argument text (e.g. "/mcp__github__pr_review 42 verbose") — extracted
/// the same way CommandMenuPopup.Filter is, so it's testable without an Avalonia control tree.
/// </summary>
